# Sunny — Known Limitations (Current)
...
"validated" claim elsewhere in `docs/current/` as scoped exactly to what it
...
- `README.md` still embeds a very large amount of historical motor
  ...
  — `docs/current/MOTOR.md` is now the concise canonical reference; trimming
