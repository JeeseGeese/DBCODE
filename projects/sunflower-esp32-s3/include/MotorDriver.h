...
// the validation work behind this configuration; VCC corrected 2026-08-01,
// see docs/V1/POWER.md -- this comment previously and incorrectly said the
// ESP32's own 3.3V pin):
//   ESP32 GPIO8 -> DRV8833 IN1
//   ESP32 GPIO9 -> DRV8833 IN2
//   Shared 5V rail -> DRV8833 VCC (same rail as the WS2812 LEDs and the
//                     MAX98357A amplifier -- see docs/V1/POWER.md)
//   ESP32 GND   -> DRV8833 GND
//   Motor       -> DRV8833 OUT1/OUT2
//
// Note: this shared 5V rail has no dedicated per-peripheral regulation --
// motor inrush combined with LED/amplifier draw has not been physically
// measured under combined load (see docs/V1/POWER.md). This wiring is
// validated working for bring-up, but an adequate external motor supply
// with common ground is recommended before sustained/loaded use.
#include <stdint.h>
